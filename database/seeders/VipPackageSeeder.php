    ...
    public function run(): void
    {
        $vipPackages = [
            [
                ...
                'price' => 50000,
                'description' => 'Gói dành cho người mới - Giảm 50%',
                'product_type' => 'package',
                'coinkey_amount' => 100, // Giá gốc bằng Coinkey
            ...
            [
                ...
                'category' => 'vip_package',
                'price' => 150000,
                'description' => 'Gói 7 ngày - VIP 1 - Giảm 75%',
                'product_type' => 'package',
                'coinkey_amount' => 300,
            ...
            [
                ...
                'category' => 'vip_package',
                'price' => 350000,
                'description' => 'Gói 30 ngày - VIP 2 - Giảm 85%',
                'product_type' => 'package',
                'coinkey_amount' => 800,
            ...
            [
                ...
                'category' => 'vip_package',
                'price' => 650000,
                'description' => 'Gói 60 ngày - VIP 3 - Giảm 90%',
                'product_type' => 'package',
                'coinkey_amount' => 1500,
            ...
            [
                ...
                'category' => 'vip_package',
                'price' => 1200000,
                'description' => 'Gói 180 ngày - VIP 3+ - Giảm 90%',
                'product_type' => 'package',
                'coinkey_amount' => 3000,
