            ...
            <form method="GET" action="{{ route('keys.index') }}" class="flex flex-col md:flex-row gap-4">
                ...
                <div class="w-full md:w-48">
                    <select name="status" onchange="this.form.submit()"
                        ...
                        <option value="suspended" {{ request('status') == 'suspended' ? 'selected' : '' }}>⚫ Bị khóa
                        </option>
                    </select>
                </div>
                <div class="w-full md:w-48">
                    <select name="type" onchange="this.form.submit()"
                        ...
                        <option value="auto_generated" {{ request('type') == 'auto_generated' ? 'selected' : '' }}>AUTO
                        </option>
                    ...
                    <div class="absolute top-4 left-4 z-10">
                        @if ($key->key_type == 'custom')
                            <span
                                ...
                                CUSTOM</span>
                        @else
                            <span class="px-2 py-1 bg-blue-100 text-blue-700 text-xs font-bold rounded-lg shadow-sm">
                                AUTO</span>
                        @endif
                    </div>
                    ...
                    <div class="p-6 pt-16">
                        ...
                        <div class="space-y-3 text-sm mb-4">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-bold dark:text-gray-300">{{ number_format($key->duration_minutes) }}
                                    phút</span>
                            </div>
                            <div class="flex justify-between items-center">
