        ...
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <!-- Wallet Display (Highlight) -->
                    <div
                        class="flex items-center bg-gray-100 dark:bg-gray-700 rounded-full pl-4 pr-1 py-1 border border-gray-200 dark:border-gray-600 transition hover:border-indigo-300 dark:hover:border-indigo-500 group">
                        ...
                        <a href="{{ route('products') }}"
                            class="w-8 h-8 bg-white dark:bg-gray-600 rounded-full flex items-center justify-center text-indigo-600 dark:text-indigo-300 shadow-sm hover:bg-indigo-600 hover:text-white dark:hover:bg-indigo-500 transition-all duration-200"
                            title="Nạp thêm">
                    ...
                    <button id="theme-toggle"
                        class="p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        <svg id="theme-icon-sun" class="w-6 h-6 text-gray-700 dark:text-gray-300 hidden dark:block"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
                        </svg>
                        <svg id="theme-icon-moon" class="w-6 h-6 text-gray-700 dark:text-gray-300 block dark:hidden"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="relative">
                        ...
                        <div x-show="notificationOpen" @click.away="notificationOpen = false"
                            ...
                            @forelse($notifications as $notif)
                                <a href="{{ $notif['link'] }}"
                                    class="flex items-start px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors border-b border-gray-100 dark:border-gray-700 last:border-b-0">
                    ...
                    <div x-data="{ profileOpen: false }" class="relative">
                        <button @click="profileOpen = !profileOpen"
                            ...
                            <svg class="w-4 h-4 text-gray-700 dark:text-gray-300 hidden sm:block" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7" />
                            </svg>
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center mt-1">
                        @if ($user->is_admin)
                            <span
                                class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-green-100 dark:bg-green-900/50 text-green-800 dark:text-green-300">
                                👑 Admin
                            </span>
                        @else
                            <span
