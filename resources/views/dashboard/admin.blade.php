        ...
        <div class="max-w-[1800px] mx-auto space-y-6">
                ...
                <div class="bg-gradient-to-br from-green-500 to-green-700 rounded-2xl shadow-xl p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-4xl font-bold mt-2">{{ number_format($transactionStats['total_revenue']) }}
                            </p>
                            <p class="text-green-200 text-xs mt-2">
                                Hôm nay: <span
                                    class="font-semibold">{{ number_format($transactionStats['today_revenue']) }}đ</span>
                            </p>
                        </div>
                        <div class="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center">
                            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-purple-200 text-xs mt-2">
                                Thành công: <span
                                    class="font-semibold">{{ number_format($transactionStats['success']) }}</span>
                            </p>
                        </div>
                        <div class="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center">
                            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-amber-200 text-xs mt-2">
                                Thất bại: <span
                                    class="font-semibold">{{ number_format($transactionStats['failed']) }}</span>
                            </p>
                        </div>
                        <div class="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center">
                            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div
                    ...
                    <div class="mt-4 grid grid-cols-2 gap-3 text-sm">
                        <div class="flex items-center justify-between p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                            ...
                            <span
                                class="font-bold text-blue-600 dark:text-blue-400">{{ number_format($userDistribution['new']) }}</span>
                        </div>
                        <div class="flex items-center justify-between p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                            <span class="text-gray-700 dark:text-gray-300">Người dùng cũ</span>
                            <span
                                class="font-bold text-green-600 dark:text-green-400">{{ number_format($userDistribution['existing']) }}</span>
                        </div>
                        <div class="flex items-center justify-between p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
                            <span class="text-gray-700 dark:text-gray-300">Đã hết hạn</span>
                            <span
                                class="font-bold text-red-600 dark:text-red-400">{{ number_format($userDistribution['expired']) }}</span>
                        </div>
                        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900/20 rounded-lg">
                            ...
                            <span
                                class="font-bold text-gray-600 dark:text-gray-400">{{ number_format($userDistribution['deleted']) }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="mt-4 grid grid-cols-2 gap-3 text-sm">
                        <div
                            ...
                            <span
                                class="font-bold text-emerald-600 dark:text-emerald-400">{{ number_format($activityStatus['very_active']) }}</span>
                        </div>
                        <div class="flex items-center justify-between p-3 bg-teal-50 dark:bg-teal-900/20 rounded-lg">
                            ...
                            <span
                                class="font-bold text-teal-600 dark:text-teal-400">{{ number_format($activityStatus['active']) }}</span>
                        </div>
                        <div class="flex items-center justify-between p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg">
                            ...
                            <span
                                class="font-bold text-amber-600 dark:text-amber-400">{{ number_format($activityStatus['inactive']) }}</span>
                        </div>
                        <div class="flex items-center justify-between p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
                            <span class="text-gray-700 dark:text-gray-300">Không hoạt động</span>
                            <span
                                class="font-bold text-red-600 dark:text-red-400">{{ number_format($activityStatus['dormant']) }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <div
                    ...
                    <div
                        class="space-y-3 max-h-[500px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
                        @forelse($topBuyers as $index => $buyer)
                            <div
                                class="flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border border-purple-200 dark:border-purple-700 hover:shadow-md transition-all">
                                <div class="flex items-center space-x-4">
                                    <div
                                        class="w-10 h-10 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-white font-bold shadow-lg">
                                        {{ $index + 1 }}
                                    </div>
                                    <div>
                                ...
                                <div class="text-right">
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">
                                        {{ number_format($buyer['total_spent']) }}đ</p>
                                </div>
                            </div>
                        @empty
                ...
                <div
                    ...
                    <div
                        ...
                        @forelse($topSpenders as $index => $spender)
                            <div
                                class="flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-700 hover:shadow-md transition-all">
                                <div class="flex items-center space-x-4">
                                    <div
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                            ...
                            <thead>
                                <tr class="border-b-2 border-gray-200 dark:border-gray-700">
                                    ...
                                    <th
                                        ...
                                        Đã bán</th>
                                    <th
                                        class="text-right py-3 px-2 text-sm font-semibold text-gray-700 dark:text-gray-300">
                                        Doanh thu</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse($topProducts as $index => $product)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                        <td class="py-3 px-2">
                                            <span
                                                class="inline-flex items-center justify-center w-8 h-8 rounded-full {{ $index < 3 ? 'bg-gradient-to-br from-orange-400 to-red-500 text-white font-bold' : 'bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-400' }} text-sm">
                                                {{ $index + 1 }}
                                            </span>
                                        </td>
                                        <td class="py-3 px-2">
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400">
                                                {{ Str::limit($product['product']->description ?? '', 30) }}</p>
                                        </td>
                                        <td class="py-3 px-2 text-center">
                                            <span
                                                class="inline-flex px-3 py-1 rounded-full text-sm font-semibold bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-400">
                                                {{ $product['sales_count'] }}
                                            </span>
                                        </td>
                ...
                <div
                    ...
                    {{-- New Expiring Users List with Quick Extend Buttons --}}
                    <div id="expiring-users-card"
                        class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
                        <div id="expiring-users-list"
                            class="space-y-3 max-h-[500px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
                            @forelse($expiringUsers as $item)
                                <div id="user-{{ $item['user']->id }}-row"
                                    class="p-4 rounded-xl border-l-4 {{ $item['days_remaining'] <= 2 ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-amber-500 bg-amber-50 dark:bg-amber-900/20' }} hover:shadow-md transition-all">
                                    <div class="flex items-center justify-between mb-2">
                                        <div class="flex items-center space-x-3">
                                            <div>
                                                <p class="font-semibold text-gray-900 dark:text-gray-100">
                                        ...
                                        <div class="text-right">
                                            <p id="days-{{ $item['user']->id }}"
                                                class="text-lg font-bold {{ $item['days_remaining'] <= 2 ? 'text-red-600 dark:text-red-400' : 'text-amber-600 dark:text-amber-400' }}">
                                                {{ $item['days_remaining'] }} ngày
                                            </p>
                                            <p id="expires-{{ $item['user']->id }}"
                                    ...
                                    <div class="flex space-x-2 mt-3">
                                        <button onclick="handleQuickExtend({{ $item['user']->id }}, 30, this)"
                                            ...
                                            class="flex-1 px-3 py-2 bg-green-500 hover:bg-green-600 text-white text-xs font-semibold rounded-lg transition-colors quick-extend-btn">
                                            Gia hạn 30 ngày
                                        </button>
                                        <button onclick="handleQuickExtend({{ $item['user']->id }}, 90, this)"
                                            data-user-name="{{ $item['user']->name }}"
                                            class="flex-1 px-3 py-2 bg-blue-500 hover:bg-blue-600 text-white text-xs font-semibold rounded-lg transition-colors quick-extend-btn">
                                            Gia hạn 90 ngày
                                        </button>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function showToast(message, type) {
            ...
            const iconPath = isSuccess ?
                // SVG Icon cho Success (Checkmark)
                '<path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />' :
                // SVG Icon cho Error (X mark)
                '<path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />';

            const toast = document.createElement('div');
            toast.classList.add('flex', 'items-center', 'w-full', 'max-w-xs', colorClass, 'text-white', 'p-4', 'rounded-lg',
                'shadow-xl', 'transition-opacity', 'duration-300', 'ease-out');
            toast.style.opacity = '0'; // Bắt đầu ẩn

            toast.innerHTML = `
            <div class="inline-flex flex-shrink-0 justify-center items-center w-8 h-8 rounded-full ${isSuccess ? 'bg-green-600' : 'bg-red-600'}">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ${iconPath}
                </svg>
            </div>
            <div class="ml-3 text-sm font-normal">${message}</div>
            <button type="button" class="ml-auto -mx-1.5 -my-1.5 bg-transparent text-white hover:text-gray-200 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-opacity-10 inline-flex h-8 w-8" onclick="this.closest('div').remove()">
        ...
        // --- LOGIC MODAL VÀ AJAX ---
        const quickExtendModal = document.getElementById('quickExtendModal');
        const quickExtendForm = document.getElementById('quickExtendForm');
        ...
        function openQuickExtendModal(button) {
            ...
            document.getElementById('modalExpiresAt').textContent = 'Hết hạn: ' + new Date(expiresAt).toLocaleDateString(
                'vi-VN');
            document.getElementById('daysError').classList.add('hidden');
            document.getElementById('daysError').textContent = '';
            quickExtendModal.classList.remove('hidden');
            quickExtendModal.classList.add('flex'); // Hiển thị modal
        }

        function closeQuickExtendModal() {
            quickExtendModal.classList.add('hidden');
            quickExtendModal.classList.remove('flex'); // Ẩn modal
        }

        async function handleQuickExtend(event) {
            ...
            // Lấy CSRF token (từ trường ẩn trong form)
            const csrfToken = document.querySelector('input[name="_token"]').value;

            // URL mới trỏ đến AccountExpirationController@extendByDays
            ...
            try {
                const response = await fetch(url, {
                    ...
                    body: JSON.stringify({
                        days: days,
                        note: 'Quick extend from dashboard'
                    })
                });
                ...
                if (response.ok) {
                    ...
                    // Tải lại trang sau khi gia hạn thành công để cập nhật bảng
                    setTimeout(() => {
                        window.location.reload();
                    }, 1000);

                } else {
                    // Xử lý lỗi validation (422) hoặc lỗi server khác
                    if (response.status === 422 && data.errors && data.errors.days) {
                        daysError.textContent = data.errors.days[0];
                        daysError.classList.remove('hidden');
                        showToast('Lỗi gia hạn: Dữ liệu không hợp lệ.', 'error');
                    } else {
                        showToast(data.message || 'Lỗi không xác định khi gia hạn.', 'error');
                    }
                }

            } catch (error) {
                console.error('Lỗi AJAX:', error);
                showToast('Lỗi kết nối hoặc xử lý server.', 'error');
            } finally {
