    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8 min-h-screen bg-gray-50 dark:bg-gray-900">
        <div class="max-w-7xl mx-auto space-y-6">
            ...
            <div class="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 dark:from-indigo-700 dark:via-purple-700 dark:to-pink-700 rounded-2xl shadow-xl p-6 sm:p-8 text-white">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="space-y-2">
                        ...
                        <p class="text-indigo-100 dark:text-indigo-200 text-sm sm:text-base">Quản lý tất cả giao dịch thanh toán</p>
                    </div>
                    <div class="flex items-center space-x-6">
                        <div class="text-center">
                            <div class="text-3xl font-bold text-white">{{ $transactions->total() }}</div>
                            <div class="text-xs text-indigo-100 dark:text-indigo-200 uppercase tracking-wide">Tổng GD</div>
                        </div>
                        <div class="h-12 w-px bg-white/30"></div>
                        <div class="text-center">
                            <div class="text-3xl font-bold text-white">{{ number_format($stats['total_amount']/1000) }}K</div>
                            <div class="text-xs text-indigo-100 dark:text-indigo-200 uppercase tracking-wide">Tổng Thu</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium">Total</p>
                            <p class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100 mt-1">{{ number_format($stats['total']) }}</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">Today: <span class="font-semibold">{{ $stats['today'] }}</span></p>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-green-600 dark:text-green-400 mt-1">{{ number_format($stats['success']) }}</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">{{ number_format($stats['total_amount']/1000) }}K</p>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-yellow-600 dark:text-yellow-400 mt-1">{{ number_format($stats['pending']) }}</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">{{ number_format($stats['pending_amount']/1000) }}K</p>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-red-600 dark:text-red-400 mt-1">{{ number_format($stats['failed'] + $stats['cancelled']) }}</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">Cancelled: {{ $stats['cancelled'] }}</p>
                        </div>
                ...
                <form method="GET" action="{{ route('admin.transactions.index') }}" class="space-y-4">
                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
                        <div>
                            ...
                            <select name="status" class="w-full px-3 py-2 bg-white dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 rounded-xl text-sm font-medium text-gray-900 dark:text-gray-100 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-4 focus:ring-indigo-500/20 transition-all duration-200 cursor-pointer">
                        ...
                        <div>
                            ...
                            <input type="date" name="date_from" value="{{ $dateFrom ?? '' }}" class="w-full px-3 py-2 bg-white dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 rounded-xl text-sm font-medium text-gray-900 dark:text-gray-100 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-4 focus:ring-indigo-500/20 transition-all duration-200">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="date_to" value="{{ $dateTo ?? '' }}" class="w-full px-3 py-2 bg-white dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 rounded-xl text-sm font-medium text-gray-900 dark:text-gray-100 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-4 focus:ring-indigo-500/20 transition-all duration-200">
                        </div>
                        ...
                        <div class="col-span-2 sm:col-span-3 lg:col-span-2">
                            ...
                            <div class="relative">
                                <input type="text" name="search" value="{{ $search ?? '' }}" placeholder="Order code, user, description..." class="w-full pl-4 pr-12 py-2 bg-white dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 rounded-xl text-sm font-medium text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-4 focus:ring-indigo-500/20 transition-all duration-200">
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="bg-gray-100 dark:bg-gray-700 border-b-2 border-gray-200 dark:border-gray-600">
                                <th class="px-3 sm:px-6 py-4 text-left text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                                    Order
                                </th>
                                <th class="px-3 sm:px-6 py-4 text-left text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider hidden lg:table-cell">
                                    User
                                </th>
                                <th class="px-3 sm:px-6 py-4 text-left text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider hidden md:table-cell">
                                    Product
                                </th>
                                <th class="px-3 sm:px-6 py-4 text-right text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                                    Amount
                                </th>
                                <th class="px-3 sm:px-6 py-4 text-center text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                                    Status
                                </th>
                                <th class="px-3 sm:px-6 py-4 text-left text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider hidden sm:table-cell">
                                    Time
                                </th>
                                <th class="px-3 sm:px-6 py-4 text-center text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                                    View
                            ...
                            @forelse ($transactions as $transaction)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                        ...
                                        <div class="flex flex-col space-y-1">
                                            ...
                                            <span class="lg:hidden text-xs text-gray-700 dark:text-gray-300 font-medium">
                                             ...
                                             <span class="text-xs text-gray-600 dark:text-gray-300 sm:hidden"> 
                                                <svg class="w-3 h-3 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26c.45.3.93.3 1.35 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                                                </svg>
                                    ...
                                    <td class="px-3 sm:px-6 py-4 hidden lg:table-cell">
                                        @if($transaction->user)
                                        <div class="flex items-center space-x-3">
                                            <div class="h-10 w-10 rounded-full bg-indigo-100 dark:bg-indigo-900/50 flex items-center justify-center flex-shrink-0">
                                                <span class="text-indigo-600 dark:text-indigo-400 font-semibold text-sm">
                                                    {{ strtoupper(substr($transaction->user->name, 0, 2)) }}
                                                </span>
                                            </div>
                                            <div class="min-w-0 flex-1">
                                                <p class="text-sm font-semibold text-gray-900 dark:text-gray-100 truncate">{{ $transaction->user->name }}</p>
                                    ...
                                    <td class="px-3 sm:px-6 py-4 hidden md:table-cell">
                                        ...
                                        <div class="flex flex-col space-y-1">
                                            <span class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ Str::limit($transaction->product->name, 25) }}</span>
                                            <span class="text-xs text-gray-500 dark:text-gray-400">{{ Str::limit($transaction->description, 35) }}</span>
                                        </div>
                                        @else
                                        <span class="text-sm text-gray-400 dark:text-gray-500 italic">{{ Str::limit($transaction->description ?? 'No product', 35) }}</span>
                                        @endif
                                    </td>

                                    <td class="px-3 sm:px-6 py-4 text-right whitespace-nowrap">
                                        <div class="flex flex-col items-end space-y-1">
                                            <span class="text-sm sm:text-base font-bold text-gray-900 dark:text-gray-100">
                                    ...
                                    <td class="px-3 sm:px-6 py-4 text-center whitespace-nowrap">
                                        ...
                                        @endphp
                                        <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold shadow-sm {{ $config['bg'] }} {{ $config['text'] }}">
                                    ...
                                    <td class="px-3 sm:px-6 py-4 text-center whitespace-nowrap">
                                        <a href="{{ route('admin.transactions.show', $transaction->id) }}" title="View details"
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-16 text-center"> 
                                        <div class="flex flex-col items-center justify-center space-y-4">
                                            <div class="w-20 h-20 sm:w-24 sm:h-24 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center">
