<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    <!-- Primary Navigation Menu --><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <!-- Settings Dropdown & DARK MODE TOGGLE --><div class="hidden sm:flex sm:items-center sm:ms-6">
                
                <!-- START: DARK MODE TOGGLE BUTTON --><button id="theme-toggle"
                    class="p-2 me-4 rounded-full shadow-md bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 transition duration-200">
                    
                    <!--chế độ Light (Sáng)--><span id="theme-toggle-dark-icon" class="text-xl transition duration-200">
                        🌞
                    </span>

                    <!--chế độ Dark (Tối)--><span id="theme-toggle-light-icon" class="text-xl transition duration-200 hidden">
                        🌙
                    </span>
                </button>
                <!-- END: DARK MODE TOGGLE BUTTON --><x-dropdown align="right" width="48">
                    <x-slot name="trigger">
