        ...
        <div class="max-w-7xl mx-auto space-y-6">
            ...
            <div class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 dark:from-indigo-700 dark:via-purple-700 dark:to-pink-700 rounded-2xl shadow-xl p-6 sm:p-8">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="space-y-2">
                        ...
                        <p class="text-white/90 text-sm sm:text-base">Khám phá các sản phẩm chất lượng cao</p>
                    </div>
                    <div class="flex items-center space-x-6">
                        <div class="text-center">
                            <div class="text-3xl font-bold text-white" id="total-products">{{ count($products) }}</div>
                            <div class="text-xs text-white/90 uppercase tracking-wide">Sản Phẩm</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" id="products-grid">
                @foreach($products as $product)
                    <div class="product-card bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2"
                         data-name="{{ strtolower($product['name']) }}" 
                         data-price="{{ $product['price'] }}"
                         data-category="{{ $product['category'] ?? '' }}">
                        
                        <!-- Product Image -->
                        <div class="relative bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-indigo-900/30 dark:to-purple-900/30 h-48 flex items-center justify-center p-6">
                            ...
                            @if(isset($product['category']))
                                <span class="absolute top-3 right-3 px-2 py-1 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm text-xs font-semibold text-gray-700 dark:text-gray-300 rounded-full border border-gray-200 dark:border-gray-600">
                                    {{ $product['category'] }}
                                </span>
                            @endif
                        </div>
                        ...
                        <div class="p-5 space-y-3">
                            ...
                            <div class="flex gap-2 pt-3">
                                ...
                                <button type="button" class="view-detail-btn p-2.5 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg transition-all duration-200"
        ...
        <div class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-2xl transform transition-all duration-300 scale-95 opacity-0 border border-gray-200 dark:border-gray-700" id="modalContent">
            ...
            <div class="flex items-center justify-end space-x-3 p-6 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-b-2xl">
                ...
                <a id="modal-pay-link" href="#"
                    class="px-6 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
                    Thanh toán ngay
                </a>
            </div>
        </div>
